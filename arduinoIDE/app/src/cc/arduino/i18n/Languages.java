...
//      new Language(tr("Afrikaans"), "Afrikaans", "af"),
//      new Language(tr("Albanian"), "shqip", "sq"),
//      new Language(tr("Arabic"), "丕賱毓乇亘賷丞", "ar"),
//      new Language(tr("Aragonese"), "Aragon茅s", "an"),
//      new Language(tr("Armenian"), "諃铡盏榨謤榨斩", "hy"),
//      new Language(tr("Asturian"), "Asturianu", "ast"),
//      new Language(tr("Basque"), "Euskara", "eu"),
//      new Language(tr("Belarusian"), "袘械谢邪褉褍褋泻邪褟 屑芯胁邪", "be"),
//      new Language(tr("Bosnian"), "Bosanski", "bs"),
//      new Language(tr("Bulgarian"), "斜褗谢谐邪褉褋泻懈", "bg"),
//      new Language(tr("Burmese (Myanmar)"), "醼椺�欋��呩��醼��", "my_MM"),
//      new Language(tr("Canadian French"), "Canadienne-fran莽ais", "fr_CA"),
//      new Language(tr("Catalan"), "Catal脿", "ca"),
//      new Language(tr("Chinese (China)"), "绠�浣撲腑鏂�", "zh_CN"),
//      new Language(tr("Chinese (Taiwan) (Big5)"), "鍙拌獮 (Big5)", "zh_TW.Big5"),
//      new Language(tr("Chinese (Taiwan)"), "鍙拌獮", "zh_TW"),
//      new Language(tr("Croatian"), "Hrvatski", "hr_HR"),
//      new Language(tr("Czech (Czech Republic)"), "膷esk媒 (Czech Republic)", "cs_CZ"),
//      new Language(tr("Danish (Denmark)"), "Dansk (Denmark)", "da_DK"),
//      new Language(tr("Dutch"), "Nederlands", "nl"),
//      new Language(tr("Dutch (Netherlands)"), "Nederlands", "nl_NL"),
//      new Language(tr("English"), "English", "en"),
...
//      new Language(tr("Filipino"), "Pilipino", "fil"),
//      new Language(tr("Finnish"), "Suomi", "fi"),
//      new Language(tr("French"), "Fran莽ais", "fr"),
//      new Language(tr("Galician"), "Galego", "gl"),
//      new Language(tr("Galician (Spain)"), "Galego (Spain)", "gl_ES"),
//      new Language(tr("Georgian"), "醿♂儛醿メ儛醿犪儣醿曖償醿氠儩醿�", "ka_GE"),
//      new Language(tr("German"), "Deutsch", "de_DE"),
//      new Language(tr("Greek"), "蔚位位畏谓喂魏维", "el_GR"),
//      new Language(tr("Hebrew"), "注讘专讬转", "he"),
//      new Language(tr("Hindi"), "啶灌た啶傕う啷�", "hi"),
//      new Language(tr("Hungarian"), "Magyar", "hu"),
//      new Language(tr("Indonesian"), "Bahasa Indonesia", "id"),
//      new Language(tr("Italian"), "Italiano", "it_IT"),
//      new Language(tr("Japanese"), "鏃ユ湰瑾�", "ja_JP"),
//      new Language(tr("Kazakh"), "賯丕夭丕賯 俅鬲賶賱賶", "kk"),
//      new Language(tr("Korean"), "頃滉淡鞏�", "ko_KR"),
//      new Language(tr("Latvian"), "Latvie拧u", "lv_LV"),
//      new Language(tr("Lithuaninan"), "Lietuvi懦 Kalba", "lt_LT"),
//      new Language(tr("Marathi"), "啶ぐ啶距啷�", "mr"),
//      new Language(tr("Nepali"), "啶ㄠ啶ぞ啶侧", "ne"),
//      new Language(tr("Norwegian Bokm氓l"), "Norsk bokm氓l", "nb_NO"),
//      new Language(tr("Persian (Iran)"), "賮丕乇爻蹖 (Iran)", "fa_IR"),
//      new Language(tr("Persian"), "賮丕乇爻蹖", "fa"),
//      new Language(tr("Polish"), "J臋zyk Polski", "pl"),
//      new Language(tr("Portugese"), "Portugu锚s", "pt"),
//      new Language(tr("Portuguese (Brazil)"), "Portugu锚s (Brazil)", "pt_BR"),
//      new Language(tr("Portuguese (Portugal)"), "Portugu锚s (Portugal)", "pt_PT"),
//      new Language(tr("Romanian"), "Rom芒n膬", "ro"),
//      new Language(tr("Russian"), "袪褍褋褋泻懈泄", "ru"),
//      new Language(tr("Slovak"), "Sloven膷ina", "sk"),
//      new Language(tr("Slovenian"), "Sloven拧膷ina", "sl_SI"),
//      new Language(tr("Spanish"), "Espa帽ol", "es"),
//      new Language(tr("Swedish"), "Svenska", "sv"),
//      new Language(tr("Talossan"), "Talossan", "tzl"),
//      new Language(tr("Tamil"), "喈む喈苦喁�", "ta"),
//      new Language(tr("Telugu"), "喟む眴喟侧眮喟椸眮", "te"),
//      new Language(tr("Thai"), "喔犩覆喔┼覆喙勦笚喔�", "th"),
//      new Language(tr("Turkish"), "T眉rk", "tr"),
//      new Language(tr("Ukrainian"), "校泻褉邪褩薪褋褜泻懈泄", "uk"),
//      new Language(tr("Vietnamese"), "Ti岷縩g Vi峄噒", "vi"),
//      new Language(tr("Western Frisian"), "Western Frisian", "fy")
//    };
//
//  }
