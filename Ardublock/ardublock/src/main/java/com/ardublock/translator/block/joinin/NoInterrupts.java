...
public class NoInterrupts extends TranslatorBlock
{
	
	public NoInterrupts(Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
